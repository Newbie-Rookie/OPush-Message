drop database if exists opush;

create database opush;
...
(
    ...
    `report_content`      var   char(50)                             NOT NULL DEFAULT '' COMMENT '回执内容',
...
drop table IF EXISTS tb_channelAccount;

CREATE TABLE `tb_channelAccount`
(
    `id`             bigint(20) NOT NULL AUTO_INCREMENT,
